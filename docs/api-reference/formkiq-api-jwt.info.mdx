...
<ApiLogo
  logo={{"url":"https://www.formkiq.com/img/formkiq-wordmark.png","backgroundColor":"#FFFFFF","altText":"FormKiQ Logo"}}
  darkLogo={undefined}
>
...
FormKiQ is an API-first (headless), battle-tested document management API. The FormKiQ API provides all the API endpoints to build your Perfect Document Management Platform.
