...
You can now add a new Claim Issuance Polic Rule for the Windows account name:

image::ad-fs-claim-issuance-add-new-rule.png['Adding a new Claim Issuance Policy Rule for Windows account name']
